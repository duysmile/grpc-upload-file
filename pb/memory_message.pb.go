...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpcuploadfile.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f,
	0x61, 0x64, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: grpcuploadfile.Memory.Unit
	(*Memory)(nil),   // 1: grpcuploadfile.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpcuploadfile.Memory.unit:type_name -> grpcuploadfile.Memory.Unit
