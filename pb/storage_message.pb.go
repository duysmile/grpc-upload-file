...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpcuploadfile.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c,
	0x6f, 0x61, 0x64, 0x66, 0x69, 0x6c, 0x65, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f,
	...
	0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61,
	...
	0x0b, 0x32, 0x16, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x66, 0x69,
	0x6c, 0x65, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: grpcuploadfile.Storage.Driver
	(*Storage)(nil),     // 1: grpcuploadfile.Storage
	(*Memory)(nil),      // 2: grpcuploadfile.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpcuploadfile.Storage.driver:type_name -> grpcuploadfile.Storage.Driver
	2, // 1: grpcuploadfile.Storage.memory:type_name -> grpcuploadfile.Memory
