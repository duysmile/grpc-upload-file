...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=grpcuploadfile.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x66, 0x69, 0x6c, 0x65, 0x22, 0xa1, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65,
	...
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x66,
	0x69, 0x6c, 0x65, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c,
	...
	0x32, 0x1c, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x66, 0x69, 0x6c,
	0x65, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x50, 0x61, 0x6e, 0x65, 0x6c, 0x52, 0x05,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: grpcuploadfile.Screen.Panel
	(*Screen)(nil),            // 1: grpcuploadfile.Screen
	(*Screen_Resolution)(nil), // 2: grpcuploadfile.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpcuploadfile.Screen.resolution:type_name -> grpcuploadfile.Screen.Resolution
	0, // 1: grpcuploadfile.Screen.panel:type_name -> grpcuploadfile.Screen.Panel
