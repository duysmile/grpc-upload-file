...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x67, 0x72, 0x70, 0x63, 0x75,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x66, 0x69, 0x6c, 0x65, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: grpcuploadfile.CPU
	(*GPU)(nil),    // 1: grpcuploadfile.GPU
	(*Memory)(nil), // 2: grpcuploadfile.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: grpcuploadfile.GPU.memory:type_name -> grpcuploadfile.Memory
